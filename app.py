...
# ==========================================
# 3. منطق شمال الإسماعيلية (النسخة اللي كانت شغالة صح)
# ==========================================
...
if page == "المحطات العامة":
    ...
    if df is not None:
        ...
        # --- هنا التعديل عشان الأسماء تظهر (Fix for Bar Chart) ---
        ...
        # اللعبة كلها هنا: إظهار كل الأسماء وتدويرها
    ...
    # --- ده الجزء اللي كان شغال صح ---
    with st.expander("🛠️ فحص الملفات", expanded=False):
